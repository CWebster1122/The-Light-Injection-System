...
int LI_Analysis()
{
  ...
  *Bi_vs_Temp_Graph, *Am_vs_Temp_Graph, *LED_Ref_vs_Temp_Graph, *LED_Calo_vs_Temp_Graph;
  ...
  std::vector<double> Ratio_Line_Diff, Ratio_Line_Diff_Err, Temp_DB_Line_Diff, Temp_DB_Line_Diff_Err, Temp_Lab_Line_Diff, Temp_Lab_Line_Diff_Err, PreCorrRatio_DB_Err, Term_PreCorr_Err, Term_Corr_Err;
  Double_t Ratio_Line_Diff_Array[size], Ratio_Line_Diff_Err_Array[size], 
	   Temp_DB_Line_Diff_Array[size], Temp_DB_Line_Diff_Err_Array[size], 
	   Temp_Lab_Line_Diff_Array[size], Temp_Lab_Line_Diff_Err_Array[size];
  ...
  std::vector<double> PreCorrRatio_DB, CorrRatio_DB, CorrRatio_DB_Err, PreCorrRatio_Lab, CorrRatio_Lab, CorrRatio_Lab_Err;
  Double_t PreCorrRatio_DB_vs_Time_Array[size], PreCorrRatio_DB_vs_Time_Err_Array[size], CorrRatio_DB_vs_Time_Array[size], CorrRatio_DB_vs_Time_Err_Array[size], PreCorrRatio_Lab_vs_Time_Array[size], PreCorrRatio_Lab_vs_Time_Err_Array[size], CorrRatio_Lab_vs_Time_Array[size], CorrRatio_Lab_vs_Time_Err_Array[size];  
   
  float precorr_c = 19; // constant to tweak
  float corr_c = 1.248; // constant to tweak
